...
public class UserController {
    ...
    public ResponseEntity<UserResponseDto> activityCheck(@RequestBody UserRequestDto requestDto) {
        return new ResponseEntity<>(userService.checkStatus(requestDto), HttpStatus.OK);
    }
}
